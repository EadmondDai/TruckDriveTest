...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarControllerFix : MonoBehaviour
    {
        ...
        private void CapSpeed()
        {
            ...
            switch (m_SpeedType)
            {
                case SpeedType.MPH:
                    ...
                    speed *= 2.23693629f;
                    SpeedText.text = ((int)speed).ToString() + " m / h";
        ...
        private void ApplyDrive(float accel, float footbrake)
        {
            ...
            switch (m_CarDriveType)
            {
                ...
                case CarDriveType.RearWheelDrive:
                    thrustTorque = accel * (m_CurrentTorque / 4f);
                    m_WheelColliders[2].motorTorque = m_WheelColliders[3].motorTorque = m_WheelColliders[4].motorTorque = m_WheelColliders[5].motorTorque = thrustTorque;
                    break;
