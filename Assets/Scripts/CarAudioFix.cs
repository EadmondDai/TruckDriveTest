...
{
    [RequireComponent(typeof (CarControllerFix))]
    public class CarAudioFix : MonoBehaviour
    {
        ...
        private CarControllerFix m_CarControllerFix; // Reference to car we are controlling


        private void StartSound()
        {
            // get the CarControllerFix ( this will not be null as we have require component)
            m_CarControllerFix = GetComponent<CarControllerFix>();
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarControllerFix.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarControllerFix.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarControllerFix.Revs);
